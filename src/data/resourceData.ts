...
export const resourcesPageData = {
  hero: {
    ...
    description: {
      ...
      additional:
        "You'll also receive ongoing reflections, practical tips, and one new free resource each month—made for folks who carry a lot.",
    },
    emailPlaceholder: 'Your email',
    ctaButton: 'Get My Free Guides',
    privacyNotice:
      "By submitting this form, you'll be signed up to my free newsletter. You can opt-out at any time. For more information, see our privacy policy.",
