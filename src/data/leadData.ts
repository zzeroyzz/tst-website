...
export const guides = [
  {
    questions: [
      "Nervous to go to the doctor?",
      "Don't feel heard?",
      "Worried you'll forget something important?"
    ],
    subtitle: "This free guide helps you:",
    benefits: [
      "Walk in calm",
      "Speak up with confidence",
      "Remember everything you need to say"
    ],
    iconUrl: "https://pvbdrbaquwivhylsmagn.supabase.co/storage/v1/object/public/tst-assets/website%20assets/Resource-Icon-1.svg",
    tags: ["Medical Appointments","Healthcare Advocacy"],
  ...
  },
  {
    questions: [
      ...
      "Feel misunderstood in conversations?",
  ...
  },
  {
    questions: [
      ...
      "Need help quieting your thoughts?",
    ...
    iconUrl: "https://pvbdrbaquwivhylsmagn.supabase.co/storage/v1/object/public/tst-assets/website%20assets/Resource-Icon-3.svg",
      tags: ["Somatic", "Inner Peace", "Self-Regulation"],
    bgColor: "bg-tst-teal",
