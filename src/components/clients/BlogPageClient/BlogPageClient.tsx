      ...
      <Section>
        <div className="text-center mb-12">
          <h1 className="text-5xl font-extrabold">
            Toasted Insights: A Mental Health & Healing Blog
          </h1>
          <p className="text-lg mt-4">
            Insights, reflections, and newsletters all in one place.
          </p>
          <div className="mt-2 text-sm text-gray-600">
            {postCounts.blog} articles • {postCounts.newsletter} newsletters •{' '}
            {postCounts.total} total posts
          </div>
        </div>
          ...
          <div className="text-center py-12">
            ...
            {(selectedTags.length > 0 || selectedType !== 'all') && (
              <Button
                ...
                className="bg-tst-yellow text-black"
              >
                Clear all filters
              </Button>
            )}
