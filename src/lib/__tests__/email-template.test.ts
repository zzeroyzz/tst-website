...
describe('Email Template Generation', () => {
  const mockEmailData = {
    ...
    main_body: 'This week we explore the nature of anxiety and how to manage it effectively.',
    main_image_url: 'https://example.com/anxiety-image.jpg',
    toasty_take: 'Remember that anxiety is a normal human emotion, and learning to work with it rather than against it can be transformative.',
    archive_posts: [
      {
  ...
  describe('Archive Posts Processing', () => {
    it('should render all archive posts', () => {
      ...
      expect(html).toContain('Practical techniques for daily stress management')
    ...
    it('should create proper links for archive posts', () => {
      ...
      expect(html).toContain('https://toastedsesametherapy.com/posts/managing-stress')
      expect(html).toContain('https://toastedsesametherapy.com/posts/mindful-breathing')
    ...
    it('should handle undefined archive posts', () => {
      const dataWithUndefinedArchive = { ...mockEmailData, archive_posts: undefined }
  ...
  describe('Security and HTML Escaping', () => {
    const maliciousData = {
      ...
      main_title: '<script>window.location="http://evil.com"</script>Malicious Title',
      main_body: 'Normal content <script>steal_cookies()</script> with embedded script',
    ...
    it('should sanitize archive post slugs', () => {
      ...
      expect(html).toContain('https://toastedsesametherapy.com/posts/../../../etc/passwd')
    })
  })
  ...
  describe('Mobile Responsiveness', () => {
    it('should include mobile-specific CSS', () => {
      ...
      expect(html).toContain('.archive-img { width: 60px !important; height: 60px !important; }')
    })
